---
title: "Thermal niche model reported in Gutaker et al. (2019)"
author:
  - R. Kyle Bocinsky
...
params:
   ...
   tdar_un: !r Sys.getenv('your username')
   tdar_pw: !r Sys.getenv('your password')
output: 
...
sites <- chronometric_data %>%
  dplyr::mutate(rice = ifelse(is.na(`Rice`), FALSE, TRUE)) %>%
  dplyr::select(Site,
                Period,
                Longitude,
                Latitude,
